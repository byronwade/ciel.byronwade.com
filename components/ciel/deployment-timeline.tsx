      ...
      {phases.map((phase, i) => (
        <div key={phase.name} className="flex gap-3">
          <div className="flex flex-col items-center">
            <div className={cn("size-2 rounded-full mt-1.5", phase.status === "ready" ? "bg-emerald-500" : phase.status === "failing" ? "bg-red-500" : phase.status === "building" ? "bg-sky-500 animate-pulse" : "bg-muted-foreground")} />
